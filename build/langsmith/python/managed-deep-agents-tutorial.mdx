---
title: Add memory and a schedule to your research assistant
sidebarTitle: Build a scheduled agent
description: Add durable memory and a daily schedule to the research assistant from the quickstart, then deploy it.
---
...
See [Memory](/langsmith/python/managed-deep-agents-memory) for details.
  ...
  <Step title="(Optional) Add a custom tool" id="add-tool">
